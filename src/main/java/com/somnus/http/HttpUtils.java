 ...
 *@Project:J2SE 
 *@class:HttpUtils 
 *@descript:HTTP（HTTPS）接口方式，工具类
 *@date:2016年6月6日 下午10:20:10
 *@author San
 *@version:V1.0
 */
public class HttpUtils {
     ...
     * @throws Exception
     */
	public static HttpsURLConnection getHttpsConnection(String uri, String cerServerFile, String cerServerPwd,String cerClientFile, String cerClientPwd) throws Exception{
	 ...
	 * @throws Exception
	 */
	 private static SSLSocketFactory getSSLSocketFactory(String cerServerFile, String cerServerPwd, String cerClientFile, String cerClientPwd) throws Exception {
